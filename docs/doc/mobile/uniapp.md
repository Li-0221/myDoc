...
+ rpx 即响应式px，一种根据屏幕宽度自适应的动态单位。以750宽的屏幕为基准，750rpx恰好为屏幕宽度，开发时屏幕宽350px，所以不缩放时1px=2rpx。屏幕变宽，rpx 实际显示效果会等比放大。
...
![image-20211103123311460](C:\Users\li\AppData\Roaming\Typora\typora-user-images\image-20211103123311460.png)
...
![image-20211103140808082](C:\Users\li\AppData\Roaming\Typora\typora-user-images\image-20211103140808082.png)

![image-20211103140826207](C:\Users\li\AppData\Roaming\Typora\typora-user-images\image-20211103140826207.png)

可以在创建或挂载的生命周期中使用，

记得要在页面销毁时uni.$off移除事件
